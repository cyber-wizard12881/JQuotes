...
public class Quote {
    ...
    public static String quote() throws FileNotFoundException, IOException{
        String quotes = "If you want to achieve greatness stop asking for permission. ~Anonymous\n" +
...
"";
        BufferedReader breader = new BufferedReader(new StringReader(quotes));
        ...
        int index = random.nextInt(0, dictionary.size());
